...
public class darjeeling_elgin_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darjeeling_elgin_hotel);

        toolbar = findViewById(R.id.toolbar_darjeeling_elgin_hotel);
        ...
        sliderLayout = findViewById(R.id.img_elgin_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_elgin);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_elgin);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.elginhotels.com/hotels-in-darjeeling-elgin-darjeeling/");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.eligin_dar);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.elgin_dar1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.elgin_dar2);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.elgin_dar3);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.elgin_dar4);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.elgin_dar5);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.elgin_dar6);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(darjeeling_elgin_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

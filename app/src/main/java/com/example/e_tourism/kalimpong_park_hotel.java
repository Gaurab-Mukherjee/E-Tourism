...
public class kalimpong_park_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalimpong_park_hotel);
        toolbar = findViewById(R.id.toolbar_kalimpong_park_hotel);
        ...
        sliderLayout = findViewById(R.id.img_park_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_park);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_park);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://www.kalimpongparkhotel.com/");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 7; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.park_kali);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.park_kali1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.park_kali2);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.park_kali3);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.park_kali4);
                    sliderView.setDescription("Lovely view's");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.park_kali5);
                    sliderView.setDescription("Biggest Restaurant");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.park_kali6);
                    sliderView.setDescription("Most clean hotel");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 7:
                    sliderView.setImageDrawable(R.drawable.family_park);
                    sliderView.setDescription("Most clean hotel");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
            }
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(kalimpong_park_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

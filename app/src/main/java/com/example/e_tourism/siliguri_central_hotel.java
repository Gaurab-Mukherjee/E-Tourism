...
public class siliguri_central_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siliguri_central_hotel);
        toolbar = findViewById(R.id.toolbar_siliguri_central_hotel);
        ...
        button = (Button) findViewById(R.id.booking_btn_central);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_central);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://www.hotelcentralplaza.in/");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.central_sili);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.central_sili1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.central_sili3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.central_sili4);
                ...
                case 4:
                    ...
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.central_sili6);
                    sliderView.setDescription("Biggest Restaurant");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.central_sili5);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(siliguri_central_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

...
public class cooch_behar_acitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cooch_behar_acitivity);
        Things_to_do_1_digha = (Button) findViewById(R.id.Things_to_do_1_coochbehar);
        Things_to_do_2_digha = (Button) findViewById(R.id.Things_to_do_2_coochbehar);
        Things_to_do_3_digha = (Button) findViewById(R.id.Things_to_do_3_coochbehar);
        Things_to_do_4_digha = (Button) findViewById(R.id.Things_to_do_4_coochbehar);
        Things_to_do_5_digha = (Button) findViewById(R.id.Things_to_do_5_coochbehar);
        g_btn_map_digha = (Button) findViewById(R.id.plan_a_map_coochbehar);
        hotel_btn_digha = (Button) findViewById(R.id.hotel_btn_coochbehar);
        toolbar = findViewById(R.id.toolbar_coochbehar);

        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Cooch Behar");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        sliderLayout = findViewById(R.id.img_coochbehar);
        ...
        Things_to_do_1_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Cooch_Behar_Palace");
        ...
        Things_to_do_2_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Rajbari_National_Park");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_3_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Sagardighi_(Cooch_Behar,_India)");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_4_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Baneswar");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_5_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://coochbehar.nic.in/Htmfiles/madanmohan_exclusive.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        g_btn_map_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("geo:26.342226, 89.448865");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
    ...
    public void open_hotel_list() {
        Intent intent = new Intent(this, MainActivity_hotel_coch_beher.class);
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_1);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_2);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_4);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_5);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_6);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.cooch_behar_7);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(cooch_behar_acitivity.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

...
public class MainActivity_hotel_siliguri_list extends AppCompatActivity {
    Toolbar toolbar;
    ListView listView;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position == 0) {
                    ...
                    Intent appInfo = new Intent(MainActivity_hotel_siliguri_list.this, siliguri_marriote_hotel.class);
                    startActivity(appInfo);
                }

                else if(position == 1) {
                    //code specific to 2nd list item
                    Intent appInfo = new Intent(MainActivity_hotel_siliguri_list.this, siliguri_barsana_hotel.class);
                    startActivity(appInfo);
                }

                else if(position == 2) {

                    Intent appInfo = new Intent(MainActivity_hotel_siliguri_list.this, siliguri_loft_hotel.class);
                    startActivity(appInfo);
                }
                else if(position == 3) {


                    Intent appInfo = new Intent(MainActivity_hotel_siliguri_list.this, siliguri_central_hotel.class);
                    startActivity(appInfo);
                }
                else if(position == 4) {

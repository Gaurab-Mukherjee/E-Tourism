...
public class digha_rohini_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digha_rohini_hotel);
        toolbar = findViewById(R.id.toolbar_rohini_hotel);
        ...
        sliderLayout = findViewById(R.id.img_rohini_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_rohini);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_rohini);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.google.com/url?sa=i&url=http%3A%2F%2Fwww.hotelrohiniinternational.com%2F&psig=AOvVaw3EBN2SqioKCjtJB1tqjSKI&ust=1592575119483000&cd=&rct=j&ved=2ahUKEwiUjLzjwovqAhVL7Y4KHVjpCs4QyK4DegUIARCsAg");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.rohini_digha);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.rohini_digha1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.rohini_digha2);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.rohini_digha3);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.rohini_digha4);
                    sliderView.setDescription("Lovely view's");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.rohini_digha_hotel);
                    sliderView.setDescription("Biggest Restaurant");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.premium_rohini);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(digha_rohini_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

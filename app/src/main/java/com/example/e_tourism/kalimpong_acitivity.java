...
public class kalimpong_acitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kalimpong_acitivity);
        Things_to_do_1_sundarban = (Button) findViewById(R.id.Things_to_do_1_kalimpong);
        Things_to_do_2_sundarban = (Button) findViewById(R.id.Things_to_do_2_kalimpong);
        Things_to_do_3_sundarban = (Button) findViewById(R.id.Things_to_do_3_kalimpong);
        Things_to_do_4_sundarban = (Button) findViewById(R.id.Things_to_do_4_kalimpong);
        Things_to_do_5_sundarban = (Button) findViewById(R.id.Things_to_do_5_kalimpong);
        g_btn_map_sundarban = (Button) findViewById(R.id.plan_a_map_kalimpong);
        hotel_btn_sundarban = (Button) findViewById(R.id.hotel_btn_kalimpong);
        toolbar = findViewById(R.id.toolbar_kalimpong);

        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Kalimpong");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        sliderLayout = findViewById(R.id.img_kalimpong);
        ...
        Things_to_do_1_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Phodong_Monastery");
        ...
        Things_to_do_2_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.tripadvisor.in/Attraction_Review-g503707-d14130534-Reviews-Delo_Park-Kalimpong_Kalimpong_District_West_Bengal.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_3_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://timesofindia.indiatimes.com/travel/kalimpong/lepcha-museum/ps53909138.cms");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_4_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.tripadvisor.in/Attraction_Review-g503707-d8368576-Reviews-Mangal_Dham-Kalimpong_Kalimpong_District_West_Bengal.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_5_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://www.bengalweekend.com/tourist.php?plc_id=48");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        g_btn_map_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("geo:27.058189,88.468434");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
    ...
    public void open_hotel_list() {
        Intent intent = new Intent(this, MainActivity_hotel_kalimpong_list.class);
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.kalimpong__1);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.kalimpong__2);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.kalimpong__3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.kalimpong__4);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.kalimpong__5);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.kalimpong__6);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.kalimpong__7);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(kalimpong_acitivity.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

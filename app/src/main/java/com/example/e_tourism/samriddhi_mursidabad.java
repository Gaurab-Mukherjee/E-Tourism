...
public class samriddhi_mursidabad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samriddhi_mursidabad);

        toolbar = findViewById(R.id.toolbar_samriddhi_hotel);
        ...
        sliderLayout = findViewById(R.id.img_samriddhi_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_samriddhi);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_samriddhi);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://samriddhi-banquet-garden-resorts.business.site/");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel2);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel3);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel4);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel5);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.samriddhi_hotel6);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(samriddhi_mursidabad.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

...
public class kol_listview extends ArrayAdapter<String> {
    ...
    kol_listview (Context c, String title[], String star[],String review[], String description[],String price[], int imgs[]){

...
public class siliguri_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.siliguri_activity);
        Things_to_do_1_sundarban = (Button) findViewById(R.id.Things_to_do_1_siliguri);
        Things_to_do_2_sundarban = (Button) findViewById(R.id.Things_to_do_2_siliguri);
        Things_to_do_3_sundarban = (Button) findViewById(R.id.Things_to_do_3_siliguri);
        Things_to_do_4_sundarban = (Button) findViewById(R.id.Things_to_do_4_siliguri);
        Things_to_do_5_sundarban = (Button) findViewById(R.id.Things_to_do_5_siliguri);
        g_btn_map_sundarban = (Button) findViewById(R.id.plan_a_map_siliguri);
        hotel_btn_sundarban = (Button) findViewById(R.id.hotel_btn_siliguri);
        toolbar = findViewById(R.id.toolbar_siliguri);

        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Siliguri");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        sliderLayout = findViewById(R.id.img_siliguri);
        ...
        Things_to_do_1_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Darjeeling_Himalayan_Railway");
        ...
        Things_to_do_2_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Salugara_Monastery");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_3_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.tripadvisor.in/Attraction_Review-g659786-d3928806-Reviews-Savin_Kingdom-Siliguri_Darjeeling_District_West_Bengal.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_4_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.northbengalwildanimalspark.in/");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_5_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.tripadvisor.in/Attraction_Review-g659786-d4138712-Reviews-Hong_Kong_Market-Siliguri_Darjeeling_District_West_Bengal.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        g_btn_map_sundarban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("geo:26.726637, 88.395594");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
    ...
    public void open_hotel_list() {
        Intent intent = new Intent(this, MainActivity_hotel_siliguri_list.class);
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.siliguri_1);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.siliguri_2);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.siliguri_3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.siliguri_4);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.siliguri_5);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.siliguri_6);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.siliguri_7);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(siliguri_activity.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

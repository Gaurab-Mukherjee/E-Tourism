...
public class kolkata_hyatt_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kolkata_hyatt_hotel);

        toolbar = findViewById(R.id.toolbar_kolkata_hyatt_hotel);
        ...
        sliderLayout = findViewById(R.id.img_hyatt_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_hyatt);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_hyatt);
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_1);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_2);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_4);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_5);
                    sliderView.setDescription("Lovely view's");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_6);
                    sliderView.setDescription("Biggest Restaurant");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.hyatt_pic_7);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(kolkata_hyatt_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

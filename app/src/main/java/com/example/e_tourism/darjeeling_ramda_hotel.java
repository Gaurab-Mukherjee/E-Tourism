...
public class darjeeling_ramda_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darjeeling_ramda_hotel);

        toolbar = findViewById(R.id.toolbar_darjeeling_ramda_hotel);
        ...
        sliderLayout = findViewById(R.id.img_ramda_hotel);
        sliderLayout.setIndicatorAnimation(IndicatorAnimations.FILL);
        sliderLayout.setScrollTimeInSec(3);

        setSliderViews();

        button = (Button) findViewById(R.id.booking_btn_ramda);
        ...
        btn = (Button) findViewById(R.id.web_site_btn_ramda);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://www.jaingrouphotels.in/");
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.ramda_dar);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_1);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_2);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_3);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_4);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_5);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.ramda_dar_6);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(darjeeling_ramda_hotel.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();

...
public class mandarmani_acitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mandarmani_acitivity);
        Things_to_do_1_digha = (Button) findViewById(R.id.Things_to_do_1_mandarmani);
        Things_to_do_2_digha = (Button) findViewById(R.id.Things_to_do_2_mandarmani);
        Things_to_do_3_digha = (Button) findViewById(R.id.Things_to_do_3_mandarmani);
        Things_to_do_4_digha = (Button) findViewById(R.id.Things_to_do_4_mandarmani);
        Things_to_do_5_digha = (Button) findViewById(R.id.Things_to_do_5_mandarmani);
        g_btn_map_digha = (Button) findViewById(R.id.plan_a_map_mandarmani);
        hotel_btn_digha = (Button) findViewById(R.id.hotel_btn_mandarmani);
        toolbar = findViewById(R.id.toolbar_mandarmani);

        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Mandarmani");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        sliderLayout = findViewById(R.id.img_mandarmani);
        ...
        Things_to_do_1_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://en.wikipedia.org/wiki/Mandarmani");
        ...
        Things_to_do_3_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.tripadvisor.in/Hotel_Review-g1584828-d11548119-Reviews-Mohana_Guest_House-Mandarmani_East_Midnapore_District_West_Bengal.html");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_4_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("https://www.justdial.com/Midnapore/Outingplan-Beach-Resort-Silampur/9999P3222-3222-180302023521-B2W2_BZDET");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        Things_to_do_5_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("http://tajpurprinceresort.com/");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        ...
        g_btn_map_digha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent != null) {
                    ...
                    Uri uri = Uri.parse("geo:21.667232, 87.712612");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
    ...
    public void open_hotel_list() {
        Intent intent = new Intent(this, MainActivity_hotel_mandarmani.class);
    ...
    private void setSliderViews() {
        for (int i = 0; i <= 6; i++) {
            ...
            switch (i) {
                case 0:
                    sliderView.setImageDrawable(R.drawable.mandarmani_1);
                    ...
                    break;
                case 1:
                    sliderView.setImageDrawable(R.drawable.mandarmani_2);
                    ...
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.mandarmani_3);
                    ...
                    break;
                case 3:
                    sliderView.setImageDrawable(R.drawable.mandarmani_4);
                    ...
                    break;
                case 4:
                    sliderView.setImageDrawable(R.drawable.mandarmani_5);
                    sliderView.setDescription("Picture Five");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 5:
                    sliderView.setImageDrawable(R.drawable.mandarmani_6);
                    sliderView.setDescription("Picture Six");
                    // sliderView.setImageUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fnature%2F&psig=AOvVaw20qbPQI8DvjjFKJEp9LdSR&ust=1583901320418000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLC8ibCKj-gCFQAAAAAdAAAAABAm");
                    break;
                case 6:
                    sliderView.setImageDrawable(R.drawable.mandarmani_7);
            ...
            sliderView.setOnSliderClickListener(new SliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(SliderView sliderView) {
                    Toast.makeText(mandarmani_acitivity.this, "This is slider" + (finalI + 1), Toast.LENGTH_SHORT).show();
